...
<body onload="ListarTareasAlumnos('');">
    <!--Barra de Navegacion-->
    ...
    <div class="container">
         <div class="row form-horizontal">
            <ul class="nav nav-tabs">
                <li class="active"><a  href="#tab_consultar" data-toggle="tab">Lista de Tareas Alumnos</a></li>                
    ...
    <script src="../Resources/js/appTareasAlumnos.js"></script>                             
