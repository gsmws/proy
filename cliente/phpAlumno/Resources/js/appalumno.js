...
function lista_tareasalumnos(valor)
{
	$(document).ready(function(){            
        $.getJSON("http://localhost:8080/PHP/web/Tareas/Service.php?IdAlumno="+valor)
            .done(function(datos_del_ws){        
                html="<table class='table table-bordered'><center><thead><tr>"
                    +"<th>Id</th><th>Titulo</th><th>Archivo URL</th>"
                    +"<th>FechaPublicacion</th><th>FechaLimite</th><th ><center>Subir Tarea</center></th></tr></thead></center><tbody>";		
                    $.each(datos_del_ws,function(indice,valor){                                                            
                        ...
                        +"</td><td>"+"<a href=''>"+"<center>Subir Tarea</center>"                        
                        +"</td></tr>";                                                        
                    });        
                $("#lista").html(html);
              ...
              .done(function(datos_del_ws){        
                  html="<table class='table table-bordered'>"
                      ...
                      $.each(datos_del_ws,function(indice,valor){                                                            
                          ...
                          +"</td><td>"+"<a href='modificar.php?id="+valor.Id+"'>"+"<center>"+'Subir Tarea'+"</center>"+"</a>"                        
                          +"</td></tr>";                                                        
                      });        
                  $("#listas").html(html);
