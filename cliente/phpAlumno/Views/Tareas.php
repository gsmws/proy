...
<body onload="ListaTareas('<?php echo $_SESSION['id'];?>');">
    <!--Barra de Navegacion-->
            ...
            <div class="tab-pane" id="tab_registrar">
                <div class="row form-horizontal">
                    <div class="panel panel-default">
                        ...
                        <input id="checkboxsi"  checked="checked"  onclick="checksi(this,'<?php echo $_SESSION['id'];?>')" type="checkbox"> Todas
                        <input id="checkbox"  onclick="check(this,'<?php echo $_SESSION['id'];?>')" type="checkbox">  Evaluadas
                        <input id="checkboxs"  onclick="checks(this,'<?php echo $_SESSION['id'];?>')" type="checkbox">  No Evaluadas
        ...
        <div class="modal fade" id="responsive" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal"  method="POST" enctype="multipart/form-data" id="formCliente">                   
                    </form>
                </div>                
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
